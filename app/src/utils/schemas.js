...
const products = {
  query: {
    ...
    category: Joi.object().keys({
      detailCategoryName: Joi.string().required().messages({
        "string.base": "detailCategoryName 은 문자 형식입니다.",
        "string.empty": "detailCategoryName 값을 입력해주세요.",
        "any.required": "detailCategoryName 필드가 비었습니다.",
      }),
      startNo: Joi.number().required().messages({
        "number.base": "startNo는 숫자 형식입니다.",
        "number.integer": "startNo는 정수입니다.",
